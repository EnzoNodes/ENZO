...
The ENZO project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/enzo-project/enzo/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ENZO project, and is not to be
confused with overall ENZO Network Protocol consensus changes.

Whether a pull request is merged into ENZO rests with the project merge
...
Patches that change ENZO consensus rules are considerably more involved than
...
Where a patchset proposes to change the ENZO consensus, it must have been
...
The project leader is the release manager for each ENZO release.
