...
RESOURCES += src/qt/enzo.qrc src/qt/enzo_locale.qrc

TRANSLATIONS += src/qt/locale/enzo_bg.ts \
                src/qt/locale/enzo_de.ts \
                src/qt/locale/enzo_en.ts \
                src/qt/locale/enzo_es.ts \
                src/qt/locale/enzo_fi.ts \
                src/qt/locale/enzo_fr.ts \
                src/qt/locale/enzo_it.ts \
                src/qt/locale/enzo_ja.ts \
                src/qt/locale/enzo_pl.ts \
                src/qt/locale/enzo_pt.ts \
                src/qt/locale/enzo_ru.ts \
                src/qt/locale/enzo_sk.ts \
                src/qt/locale/enzo_sv.ts \
                src/qt/locale/enzo_vi.ts \
                src/qt/locale/enzo_zh_CN.ts \
                src/qt/locale/enzo_zh_TW.ts
