#!/usr/bin/env python3
# Copyright (c) 2020 The ENZO developers
...
class SaplingMempoolTest(enzoTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 ENZ note to Alice
        ...
        # miner sends another 10 ENZ note to Alice
