...
"""Verify that starting enzo with -h works as expected."""
import subprocess

from test_framework.test_framework import enzoTestFramework
from test_framework.util import assert_equal

class HelpTest(enzoTestFramework):
    ...
    def run_test(self):
        self.log.info("Start enzo with -? for help text")
        ...
        self.log.info("Start enzo with -version for version information")
