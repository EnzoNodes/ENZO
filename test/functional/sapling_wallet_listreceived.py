...
class ListReceivedTest (enzoTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 ENZ.
        ...
        # Send 1 ENZ to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 ENZ sending them all (fee is 0.1 ENZ)
        ...
        # Confirm transaction (2 ENZ from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 ENZ, send 0.6 ENZ + 0.05 ENZ fee
