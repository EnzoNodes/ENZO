...
from test_framework.test_framework import enzoTier2TestFramework
...
class MasternodeGovernanceBasicTest(enzoTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.enzo.org/t/test-proposal"
