...
The script [extract-osx-sdk.sh](https://github.com/enzo-project/enzo/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
enzo/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/enzo-project/enzo/blob/master/doc/README_osx.md) for troubleshooting tips.
