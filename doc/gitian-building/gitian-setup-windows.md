...
The build script we'll be using is contained in the ENZO github repository ([contrib/gitian-build.py](https://github.com/enzo-project/enzo/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the ENZO repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/ENZO-Project/ENZO/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, enzo-detached-sigs, and enzo GitHub repos.
