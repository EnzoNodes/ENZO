...
1. Clone the ENZO source code:

        git clone https://github.com/enzo-project/enzo
        cd enzo
...
ENZO is now available at `./src/enzod`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/ENZO"

    touch "/Users/${USER}/Library/Application Support/ENZO/enzo.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/ENZO/enzo.conf"

The first time you run enzod, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/ENZO/debug.log

Other commands:
-------

    ./src/enzod -daemon # Starts the enzo daemon.
    ./src/enzo-cli --help # Outputs a list of command-line options.
    ./src/enzo-cli help # Outputs a list of RPC commands when the daemon is running.
