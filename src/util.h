...
extern const char * const ENZO_CONF_FILENAME;
extern const char * const ENZO_PID_FILENAME;
extern const char * const ENZO_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("enzo-%s", name);
