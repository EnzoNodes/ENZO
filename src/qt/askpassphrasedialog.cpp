...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            ENZOGUI* window = static_cast<ENZOGUI*>(parentWidget());
...
{
    ENZOGUI* gui = static_cast<ENZOGUI*>(parentWidget());
...
{
    hide();
    static_cast<ENZOGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("ENZO will close now to finish the encryption process. "
