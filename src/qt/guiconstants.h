...
/* enzo GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ENZO"
#define QAPP_ORG_DOMAIN "enzo.org"
#define QAPP_APP_NAME_DEFAULT "ENZO-Qt"
#define QAPP_APP_NAME_TESTNET "ENZO-Qt-testnet"
