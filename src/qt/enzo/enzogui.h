...
#ifndef ENZO_CORE_NEW_GUI_ENZOGUI_H
#define ENZO_CORE_NEW_GUI_ENZOGUI_H
...
#include "qt/enzo/navmenuwidget.h"
#include "qt/enzo/topbar.h"
#include "qt/enzo/dashboardwidget.h"
#include "qt/enzo/send.h"
#include "qt/enzo/receivewidget.h"
#include "qt/enzo/addresseswidget.h"
#include "qt/enzo/coldstakingwidget.h"
#include "qt/enzo/masternodeswidget.h"
#include "qt/enzo/snackbar.h"
#include "qt/enzo/settings/settingswidget.h"
...
/**
  ENZO GUI main class. This class represents the main window of the ENZO UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ENZOGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ENZOGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~ENZOGUI();
...
#endif //ENZO_CORE_NEW_GUI_ENZOGUI_H
