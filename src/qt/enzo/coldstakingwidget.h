...
#include "qt/enzo/furabstractlistitemdelegate.h"
#include "qt/enzo/txviewholder.h"
#include "qt/enzo/tooltipmenu.h"
#include "qt/enzo/sendmultirow.h"
#include "qt/enzo/coldstakingmodel.h"
#include "qt/enzo/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(ENZOGUI* parent);
    ~ColdStakingWidget();
