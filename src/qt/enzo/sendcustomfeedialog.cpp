...
#include "qt/enzo/sendcustomfeedialog.h"
#include "qt/enzo/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(ENZOGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &ENZOGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
