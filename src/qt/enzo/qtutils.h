...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, ENZOGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, ENZOGUI* gui, double posX = 3);
