...
#include "qt/enzo/forms/ui_coldstakingwidget.h"
#include "qt/enzo/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/enzo/requestdialog.h"
#include "qt/enzo/tooltipmenu.h"
#include "qt/enzo/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(ENZOGUI* parent) :
    PWidget(parent),
