...
#include "qt/enzo/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/enzo/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(ENZOGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to ENZOGUI::handleRestart()
