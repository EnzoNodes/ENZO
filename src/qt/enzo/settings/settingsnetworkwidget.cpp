...
#include "qt/enzo/settings/settingsnetworkwidget.h"
#include "qt/enzo/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/enzo/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(ENZOGUI* _window, QWidget *parent) :
