...
#include <QWidget>
#include "qt/enzo/pwidget.h"
#include "qt/enzo/settings/settingsbackupwallet.h"
#include "qt/enzo/settings/settingsexportcsv.h"
#include "qt/enzo/settings/settingsbittoolwidget.h"
#include "qt/enzo/settings/settingssignmessagewidgets.h"
#include "qt/enzo/settings/settingswalletrepairwidget.h"
#include "qt/enzo/settings/settingswalletoptionswidget.h"
#include "qt/enzo/settings/settingsmainoptionswidget.h"
#include "qt/enzo/settings/settingsdisplayoptionswidget.h"
#include "qt/enzo/settings/settingsmultisendwidget.h"
#include "qt/enzo/settings/settingsinformationwidget.h"
#include "qt/enzo/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(ENZOGUI* parent);
    ~SettingsWidget();
