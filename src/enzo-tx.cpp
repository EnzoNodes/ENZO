...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("enzo enzo-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  enzo-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded enzo transaction") + "\n" +
                               "  enzo-tx [options] -create [commands]   " + _("Create hex-encoded enzo transaction") + "\n" +
                               "\n";
...
static CAmount AmountFromValue(const UniValue& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 20000000)
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded enzo transaction
